...
import SmartSelectColoredDumb from './SmartSelectColoredDumb';

export default class SmartSelectColored extends Component {
  static propTypes = {
  ...
  render() {
    const { colored, fieldName, options } = this.props;
    const { dropup, requestStatus: status, value } = this.state;

    return (
      <SmartSelectColoredDumb
        colored={colored}
